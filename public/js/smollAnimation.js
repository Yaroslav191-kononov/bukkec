...
let mainAnimation=[
    {
        margin:"0 -20% 0 0",
        img:"https://bukkec-production.up.railway.app/images/загруженное55.png",
        shadow:"drop-shadow(-8px 8px 10px rgb(225, 233, 234))"
    },
    {
        margin:"0 0 0 -50%",
        img:"https://bukkec-production.up.railway.app/images/загруженное33.png",
        shadow:"drop-shadow(8px -8px 10px rgb(225, 233, 234))"
    },
    {
        margin:"0 -20% 0 0",
        img:"https://bukkec-production.up.railway.app/images/загруженное22.png",
        shadow:"drop-shadow(-8px 8px 10px rgb(225, 233, 234))"
    },
    {
        margin:"0 0 0 -50%",
        img:"https://bukkec-production.up.railway.app/images/загруженное11.png",
        shadow:"drop-shadow(8px -8px 10px rgb(225, 233, 234))"
    }
];
